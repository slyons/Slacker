  ...
  Slacker:{
   Client:{
    Main:function()
    {
     ...
     arg00=function()
     {
      return function()
      {
       ...
       {
        return Concurrency.Bind(AjaxRemotingProvider.Async("Slacker:0",[input.get_Value()]),function(_arg11)
        {
    ...
    Start:function(input,k)
    {
     ...
     {
      return Concurrency.Bind(AjaxRemotingProvider.Async("Slacker:0",[input]),function(_arg1)
      {
